...
public class FlightInfo {
    ...
    private void addAddPassengerButton (FlightInfo flightInfo, ArrayList<PassengerPanel> passengersPanels, ArrayList<RemovePassengerButton> removePassengerButtons,
