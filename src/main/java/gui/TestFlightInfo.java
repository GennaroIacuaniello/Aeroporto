...
public class TestFlightInfo {
    ...
    public static void main(String[] args) throws InvalidPassengerNumber {
        ...
        controller.getFlightController().getFlight().add_booking(new Booking(new Customer("x", "x"), controller.getFlightController().getFlight(), passengers2, BookingStatus.confirmed));
